  ...
  public function render() {
    $build['filter_form'] = [
      ...
      'search_form' => [
        ...
        '#attributes' => [
          'method' => 'get',
          'action' => \Drupal\Core\Url::fromRoute('entity.zinco_retos_evaluacion.collection')->toString(),
        ],
        'label' => [
          '#type' => 'textfield',
          '#name' => 'label',
        ...
        'reset' => [
          ...
          '#url' => \Drupal\Core\Url::fromRoute('entity.zinco_retos_evaluacion.collection'),
