...
/**
 * Provides a list controller for the zinco retos soluciones entity type.
 */
final class ZincoRetosSolucionesListBuilder extends EntityListBuilder {
  ...
  public function buildRow(EntityInterface $entity): array {
    /** @var \Drupal\zinco_retos_soluciones\ZincoRetosSolucionesInterface $entity */
    $row['id'] = $entity->id();
